                    ...
                    tabItems(
                      ...
                      tabItem("Regla",
                              tags$iframe(style="height:400px; width:100%; scrolling=yes",
                                          src="Reglas de uso CLUSTER INMGENE ENERO 2022.pdf"
                              )
                      ),
                      ...
                      tabItem(tabName = "Contacto",
                              fluidRow(
                                ...
                                type="image/jpg",src="Contactas.jpg",
                                contols="controls"), width = 5, status = "primary", solidHeader = T),
                      ...
                      tabItem(tabName="imag",
                              fluidRow(
                                box(title="Agradecimientos", tags$image(type = "image/jpg",src = "Agradecimientas.jpg",
                                                                      controls = "controls", height="400px", width="600px"), 
                                  width=5, status="primary", solidHeader=T),
                                box(title="Agradecimientos",
                                    p(h3("El"), strong(h3("INSTITUTO NACIONAL DE MEDICINA GENOMICA (INMEGEN), "),
                                                   h3("agradece la participaciòn del ingeniero "),
                                                   strong(h3("Israel Aguilar Ordoñez")))))
                              )
                              )
